...
function createCard(classId, metodId, name) {
    return `
        <div class="card"> 
            <div class="${classId}" onclick="${metodId}()">
                ${name}
             </div>
        </div>
    `;
...
function createCards() {
    return `
        <div id="cards">
            ${createCard('header green', 'showTools', 'Verktøy')}
        </div>
    `;
}
...
function createButton(nameId, name) {
    return `<button onclick="${nameId}">${name}</button>`;
}
...
function createButtons() {
    return ( createButton("noLayout", "Ingen layout") +
        createButton("verticalLayout", "Vertikal layout") +
        createButton("horizontalLayout", "Horisontal layout") +
        createButton("gridLayout", " Grid layout")
    );
}

function updateView() {
    document.getElementById('app').innerHTML = createButtons() + createCards();
